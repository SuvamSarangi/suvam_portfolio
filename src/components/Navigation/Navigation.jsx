...
const Navigation = () => {
  ...
  return (
    <nav
      className="fixed top-0 left-0 w-full text-white flex justify-around items-center py-5 z-30
    ...
    >
      ...
      <ul className="md:flex space-x-10 text-base font-medium hidden">
      ...
      <div className="hidden md:block ">
        <div className="flex gap-5">
          <a
            href="https://www.linkedin.com/in/subham-sarangi/"
            target="_blank"
